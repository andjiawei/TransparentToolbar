 ...
 */
public class TransparentScrollViewToolBar extends RelativeLayout {

    private static final String TAG = TransparentScrollViewToolBar.class.getSimpleName();
    ...
    public TransparentScrollViewToolBar(Context context) {
        super(context);
        init();
    }

    public TransparentScrollViewToolBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TransparentScrollViewToolBar(Context context, AttributeSet attrs, int defStyleAttr) {
